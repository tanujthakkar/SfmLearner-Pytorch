...
class DispNetS(nn.Module):
    ...
    def __init__(self, alpha=10, beta=0.01):
        ...
        self.conv7_1x1 = nn.Conv2d(conv_planes[5], conv_planes[5], kernel_size=1, padding=0)
        self.conv6_1x1 = nn.Conv2d(conv_planes[4], conv_planes[4], kernel_size=1, padding=0)
        self.conv5_1x1 = nn.Conv2d(conv_planes[3], conv_planes[3], kernel_size=1, padding=0)
        self.conv4_1x1 = nn.Conv2d(conv_planes[2], conv_planes[2], kernel_size=1, padding=0)
        self.conv3_1x1 = nn.Conv2d(conv_planes[1], conv_planes[1], kernel_size=1, padding=0)
        self.conv2_1x1 = nn.Conv2d(conv_planes[0], conv_planes[0], kernel_size=1, padding=0)
    ...
    def forward(self, x):
        ...
        out_upconv3 = self.conv3_1x1(out_upconv3)
        ...
        out_upconv2 = self.conv2_1x1(out_upconv2)
